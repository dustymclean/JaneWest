...
const COLLECTIONS_EXTENDED = [
  {
    id: 'series-01',
    category: 'ART DECO',
    title: 'The Twenties Collection',
    subtitle: 'Classic Art Deco Elegance',
    description: 'Water pipes, bubblers, hand pipes, and ashtrays crafted with precision.',
    mainLink: 'https://janewest.com/collections/the-twenties-collection',
    featuredItems: ['Water Pipes', 'Bubblers', 'Beakers (Hand Pipes)', 'Ashtrays'],
    itemLinks: {
      ...
      'Beakers (Hand Pipes)': 'https://janewest.com/products/twenties-collection-hand-pipe-clear',
      'Ashtrays': 'https://janewest.com/products/twenties-collection-ashtray-clear',
    },
    seoCluster: 'Art Deco glassware, borosilicate water pipes, elegant smoking accessories',
  },
  {
    id: 'series-02',
    category: 'TRAVEL',
    title: 'The Travel Collection',
    subtitle: 'Portable Luxury Tools',
    description: 'Flasks, mascara wands, and compact tools designed for life on the move.',
    ...
    seoCluster: 'Travel collection, luxury flasks, mascara tools, compact design',
  },
  {
    id: 'series-03',
    category: 'DAILY',
    ...
    description: 'High-precision borosilicate pieces for daily rituals.',
    ...
    seoCluster: 'Daily borosilicate glass accessories, precision one-hitters, compact pipes',
  },
  {
    id: 'series-04',
    ...
    description: 'Premium beakers, steamrollers, and bubblers from our GRAV collaboration.',
    mainLink: 'https://janewest.com/collections/collaboration-grav',
    ...
    seoCluster: 'Collaborative glassware, GRAV Labs, premium beakers and bubblers',
  },
  {
    id: 'series-05',
    category: 'WELLNESS',
    title: "Jane's Brew",
    subtitle: 'Functional wellness infused in every cup',
    description: 'CBD capsules and K-cups designed for chill, happy, and serenity rituals.',
    ...
    seoCluster: 'CBD wellness, Jane’s Brew K-cups, relaxation capsules',
  },
];
